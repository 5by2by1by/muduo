...
examples/pingpong/CMakeFiles/pingpong_server.dir/server.cc.o: ../examples/pingpong/server.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/pingpong/CMakeFiles/pingpong_server.dir/server.cc.o"
	cd /tmp/muduo/build/examples/pingpong && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/pingpong_server.dir/server.cc.o -c /tmp/muduo/examples/pingpong/server.cc
...
examples/pingpong/CMakeFiles/pingpong_server.dir/server.cc.i: cmake_force
	...
	cd /tmp/muduo/build/examples/pingpong && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/muduo/examples/pingpong/server.cc > CMakeFiles/pingpong_server.dir/server.cc.i
...
examples/pingpong/CMakeFiles/pingpong_server.dir/server.cc.s: cmake_force
	...
	cd /tmp/muduo/build/examples/pingpong && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/muduo/examples/pingpong/server.cc -o CMakeFiles/pingpong_server.dir/server.cc.s
...
bin/pingpong_server: examples/pingpong/CMakeFiles/pingpong_server.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/pingpong_server"
	cd /tmp/muduo/build/examples/pingpong && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/pingpong_server.dir/link.txt --verbose=$(VERBOSE)
...
examples/pingpong/CMakeFiles/pingpong_server.dir/clean:
	cd /tmp/muduo/build/examples/pingpong && $(CMAKE_COMMAND) -P CMakeFiles/pingpong_server.dir/cmake_clean.cmake
.PHONY : examples/pingpong/CMakeFiles/pingpong_server.dir/clean

examples/pingpong/CMakeFiles/pingpong_server.dir/depend:
	cd /tmp/muduo/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/muduo /tmp/muduo/examples/pingpong /tmp/muduo/build /tmp/muduo/build/examples/pingpong /tmp/muduo/build/examples/pingpong/CMakeFiles/pingpong_server.dir/DependInfo.cmake --color=$(COLOR)
