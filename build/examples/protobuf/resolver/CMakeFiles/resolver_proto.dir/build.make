...
examples/protobuf/resolver/resolver.pb.cc: ../examples/protobuf/resolver/resolver.proto
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating resolver.pb.cc, resolver.pb.h"
	cd /tmp/muduo/build/examples/protobuf/resolver && protoc --cpp_out . /tmp/muduo/examples/protobuf/resolver/resolver.proto -I/tmp/muduo/examples/protobuf/resolver
...
examples/protobuf/resolver/CMakeFiles/resolver_proto.dir/resolver.pb.cc.o: examples/protobuf/resolver/resolver.pb.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object examples/protobuf/resolver/CMakeFiles/resolver_proto.dir/resolver.pb.cc.o"
	cd /tmp/muduo/build/examples/protobuf/resolver && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -Wno-conversion -Wno-shadow -o CMakeFiles/resolver_proto.dir/resolver.pb.cc.o -c /tmp/muduo/build/examples/protobuf/resolver/resolver.pb.cc
...
examples/protobuf/resolver/CMakeFiles/resolver_proto.dir/resolver.pb.cc.i: cmake_force
	...
	cd /tmp/muduo/build/examples/protobuf/resolver && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -Wno-conversion -Wno-shadow -E /tmp/muduo/build/examples/protobuf/resolver/resolver.pb.cc > CMakeFiles/resolver_proto.dir/resolver.pb.cc.i
...
examples/protobuf/resolver/CMakeFiles/resolver_proto.dir/resolver.pb.cc.s: cmake_force
	...
	cd /tmp/muduo/build/examples/protobuf/resolver && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -Wno-conversion -Wno-shadow -S /tmp/muduo/build/examples/protobuf/resolver/resolver.pb.cc -o CMakeFiles/resolver_proto.dir/resolver.pb.cc.s
...
lib/libresolver_proto.a: examples/protobuf/resolver/CMakeFiles/resolver_proto.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX static library ../../../lib/libresolver_proto.a"
	cd /tmp/muduo/build/examples/protobuf/resolver && $(CMAKE_COMMAND) -P CMakeFiles/resolver_proto.dir/cmake_clean_target.cmake
	cd /tmp/muduo/build/examples/protobuf/resolver && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/resolver_proto.dir/link.txt --verbose=$(VERBOSE)
...
examples/protobuf/resolver/CMakeFiles/resolver_proto.dir/clean:
	cd /tmp/muduo/build/examples/protobuf/resolver && $(CMAKE_COMMAND) -P CMakeFiles/resolver_proto.dir/cmake_clean.cmake
...
examples/protobuf/resolver/CMakeFiles/resolver_proto.dir/depend: examples/protobuf/resolver/resolver.pb.h
	cd /tmp/muduo/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/muduo /tmp/muduo/examples/protobuf/resolver /tmp/muduo/build /tmp/muduo/build/examples/protobuf/resolver /tmp/muduo/build/examples/protobuf/resolver/CMakeFiles/resolver_proto.dir/DependInfo.cmake --color=$(COLOR)
