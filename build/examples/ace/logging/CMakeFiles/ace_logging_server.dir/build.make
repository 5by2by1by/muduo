...
examples/ace/logging/CMakeFiles/ace_logging_server.dir/server.cc.o: ../examples/ace/logging/server.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/ace/logging/CMakeFiles/ace_logging_server.dir/server.cc.o"
	cd /tmp/muduo/build/examples/ace/logging && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/ace_logging_server.dir/server.cc.o -c /tmp/muduo/examples/ace/logging/server.cc
...
examples/ace/logging/CMakeFiles/ace_logging_server.dir/server.cc.i: cmake_force
	...
	cd /tmp/muduo/build/examples/ace/logging && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/muduo/examples/ace/logging/server.cc > CMakeFiles/ace_logging_server.dir/server.cc.i
...
examples/ace/logging/CMakeFiles/ace_logging_server.dir/server.cc.s: cmake_force
	...
	cd /tmp/muduo/build/examples/ace/logging && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/muduo/examples/ace/logging/server.cc -o CMakeFiles/ace_logging_server.dir/server.cc.s
...
bin/ace_logging_server: examples/ace/logging/CMakeFiles/ace_logging_server.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/ace_logging_server"
	cd /tmp/muduo/build/examples/ace/logging && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/ace_logging_server.dir/link.txt --verbose=$(VERBOSE)
...
examples/ace/logging/CMakeFiles/ace_logging_server.dir/clean:
	cd /tmp/muduo/build/examples/ace/logging && $(CMAKE_COMMAND) -P CMakeFiles/ace_logging_server.dir/cmake_clean.cmake
...
examples/ace/logging/CMakeFiles/ace_logging_server.dir/depend:
	cd /tmp/muduo/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/muduo /tmp/muduo/examples/ace/logging /tmp/muduo/build /tmp/muduo/build/examples/ace/logging /tmp/muduo/build/examples/ace/logging/CMakeFiles/ace_logging_server.dir/DependInfo.cmake --color=$(COLOR)
