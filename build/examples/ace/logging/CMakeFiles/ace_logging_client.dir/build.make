...
examples/ace/logging/CMakeFiles/ace_logging_client.dir/client.cc.o: ../examples/ace/logging/client.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/ace/logging/CMakeFiles/ace_logging_client.dir/client.cc.o"
	cd /tmp/muduo/build/examples/ace/logging && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/ace_logging_client.dir/client.cc.o -c /tmp/muduo/examples/ace/logging/client.cc
...
examples/ace/logging/CMakeFiles/ace_logging_client.dir/client.cc.i: cmake_force
	...
	cd /tmp/muduo/build/examples/ace/logging && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/muduo/examples/ace/logging/client.cc > CMakeFiles/ace_logging_client.dir/client.cc.i
...
examples/ace/logging/CMakeFiles/ace_logging_client.dir/client.cc.s: cmake_force
	...
	cd /tmp/muduo/build/examples/ace/logging && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/muduo/examples/ace/logging/client.cc -o CMakeFiles/ace_logging_client.dir/client.cc.s
...
bin/ace_logging_client: examples/ace/logging/CMakeFiles/ace_logging_client.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/ace_logging_client"
	cd /tmp/muduo/build/examples/ace/logging && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/ace_logging_client.dir/link.txt --verbose=$(VERBOSE)
...
examples/ace/logging/CMakeFiles/ace_logging_client.dir/clean:
	cd /tmp/muduo/build/examples/ace/logging && $(CMAKE_COMMAND) -P CMakeFiles/ace_logging_client.dir/cmake_clean.cmake
...
examples/ace/logging/CMakeFiles/ace_logging_client.dir/depend:
	cd /tmp/muduo/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/muduo /tmp/muduo/examples/ace/logging /tmp/muduo/build /tmp/muduo/build/examples/ace/logging /tmp/muduo/build/examples/ace/logging/CMakeFiles/ace_logging_client.dir/DependInfo.cmake --color=$(COLOR)
