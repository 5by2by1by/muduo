...
examples/asio/chat/CMakeFiles/asio_chat_server.dir/server.cc.o: ../examples/asio/chat/server.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/asio/chat/CMakeFiles/asio_chat_server.dir/server.cc.o"
	cd /tmp/muduo/build/examples/asio/chat && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/asio_chat_server.dir/server.cc.o -c /tmp/muduo/examples/asio/chat/server.cc
...
examples/asio/chat/CMakeFiles/asio_chat_server.dir/server.cc.i: cmake_force
	...
	cd /tmp/muduo/build/examples/asio/chat && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/muduo/examples/asio/chat/server.cc > CMakeFiles/asio_chat_server.dir/server.cc.i
...
examples/asio/chat/CMakeFiles/asio_chat_server.dir/server.cc.s: cmake_force
	...
	cd /tmp/muduo/build/examples/asio/chat && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/muduo/examples/asio/chat/server.cc -o CMakeFiles/asio_chat_server.dir/server.cc.s
...
bin/asio_chat_server: examples/asio/chat/CMakeFiles/asio_chat_server.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/asio_chat_server"
	cd /tmp/muduo/build/examples/asio/chat && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/asio_chat_server.dir/link.txt --verbose=$(VERBOSE)
...
examples/asio/chat/CMakeFiles/asio_chat_server.dir/clean:
	cd /tmp/muduo/build/examples/asio/chat && $(CMAKE_COMMAND) -P CMakeFiles/asio_chat_server.dir/cmake_clean.cmake
.PHONY : examples/asio/chat/CMakeFiles/asio_chat_server.dir/clean

examples/asio/chat/CMakeFiles/asio_chat_server.dir/depend:
	cd /tmp/muduo/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/muduo /tmp/muduo/examples/asio/chat /tmp/muduo/build /tmp/muduo/build/examples/asio/chat /tmp/muduo/build/examples/asio/chat/CMakeFiles/asio_chat_server.dir/DependInfo.cmake --color=$(COLOR)
