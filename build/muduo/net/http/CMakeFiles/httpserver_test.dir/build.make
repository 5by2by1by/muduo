...
muduo/net/http/CMakeFiles/httpserver_test.dir/tests/HttpServer_test.cc.o: ../muduo/net/http/tests/HttpServer_test.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object muduo/net/http/CMakeFiles/httpserver_test.dir/tests/HttpServer_test.cc.o"
	cd /tmp/muduo/build/muduo/net/http && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/httpserver_test.dir/tests/HttpServer_test.cc.o -c /tmp/muduo/muduo/net/http/tests/HttpServer_test.cc
...
muduo/net/http/CMakeFiles/httpserver_test.dir/tests/HttpServer_test.cc.i: cmake_force
	...
	cd /tmp/muduo/build/muduo/net/http && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/muduo/muduo/net/http/tests/HttpServer_test.cc > CMakeFiles/httpserver_test.dir/tests/HttpServer_test.cc.i
...
muduo/net/http/CMakeFiles/httpserver_test.dir/tests/HttpServer_test.cc.s: cmake_force
	...
	cd /tmp/muduo/build/muduo/net/http && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/muduo/muduo/net/http/tests/HttpServer_test.cc -o CMakeFiles/httpserver_test.dir/tests/HttpServer_test.cc.s
...
bin/httpserver_test: muduo/net/http/CMakeFiles/httpserver_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/httpserver_test"
	cd /tmp/muduo/build/muduo/net/http && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/httpserver_test.dir/link.txt --verbose=$(VERBOSE)
...
muduo/net/http/CMakeFiles/httpserver_test.dir/clean:
	cd /tmp/muduo/build/muduo/net/http && $(CMAKE_COMMAND) -P CMakeFiles/httpserver_test.dir/cmake_clean.cmake
.PHONY : muduo/net/http/CMakeFiles/httpserver_test.dir/clean

muduo/net/http/CMakeFiles/httpserver_test.dir/depend:
	cd /tmp/muduo/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/muduo /tmp/muduo/muduo/net/http /tmp/muduo/build /tmp/muduo/build/muduo/net/http /tmp/muduo/build/muduo/net/http/CMakeFiles/httpserver_test.dir/DependInfo.cmake --color=$(COLOR)
