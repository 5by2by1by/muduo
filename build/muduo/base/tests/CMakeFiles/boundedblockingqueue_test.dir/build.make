...
muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.o: ../muduo/base/tests/BoundedBlockingQueue_test.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.o"
	cd /tmp/muduo/build/muduo/base/tests && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.o -c /tmp/muduo/muduo/base/tests/BoundedBlockingQueue_test.cc
...
muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.i: cmake_force
	...
	cd /tmp/muduo/build/muduo/base/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/muduo/muduo/base/tests/BoundedBlockingQueue_test.cc > CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.i
...
muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.s: cmake_force
	...
	cd /tmp/muduo/build/muduo/base/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/muduo/muduo/base/tests/BoundedBlockingQueue_test.cc -o CMakeFiles/boundedblockingqueue_test.dir/BoundedBlockingQueue_test.cc.s
...
bin/boundedblockingqueue_test: muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/boundedblockingqueue_test"
	cd /tmp/muduo/build/muduo/base/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/boundedblockingqueue_test.dir/link.txt --verbose=$(VERBOSE)
...
muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/clean:
	cd /tmp/muduo/build/muduo/base/tests && $(CMAKE_COMMAND) -P CMakeFiles/boundedblockingqueue_test.dir/cmake_clean.cmake
...
muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/depend:
	cd /tmp/muduo/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/muduo /tmp/muduo/muduo/base/tests /tmp/muduo/build /tmp/muduo/build/muduo/base/tests /tmp/muduo/build/muduo/base/tests/CMakeFiles/boundedblockingqueue_test.dir/DependInfo.cmake --color=$(COLOR)
