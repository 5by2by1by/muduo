...
muduo/base/tests/CMakeFiles/fileutil_test.dir/FileUtil_test.cc.o: ../muduo/base/tests/FileUtil_test.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object muduo/base/tests/CMakeFiles/fileutil_test.dir/FileUtil_test.cc.o"
	cd /tmp/muduo/build/muduo/base/tests && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/fileutil_test.dir/FileUtil_test.cc.o -c /tmp/muduo/muduo/base/tests/FileUtil_test.cc
...
muduo/base/tests/CMakeFiles/fileutil_test.dir/FileUtil_test.cc.i: cmake_force
	...
	cd /tmp/muduo/build/muduo/base/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /tmp/muduo/muduo/base/tests/FileUtil_test.cc > CMakeFiles/fileutil_test.dir/FileUtil_test.cc.i
...
muduo/base/tests/CMakeFiles/fileutil_test.dir/FileUtil_test.cc.s: cmake_force
	...
	cd /tmp/muduo/build/muduo/base/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /tmp/muduo/muduo/base/tests/FileUtil_test.cc -o CMakeFiles/fileutil_test.dir/FileUtil_test.cc.s
...
bin/fileutil_test: muduo/base/tests/CMakeFiles/fileutil_test.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/muduo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/fileutil_test"
	cd /tmp/muduo/build/muduo/base/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/fileutil_test.dir/link.txt --verbose=$(VERBOSE)
...
muduo/base/tests/CMakeFiles/fileutil_test.dir/clean:
	cd /tmp/muduo/build/muduo/base/tests && $(CMAKE_COMMAND) -P CMakeFiles/fileutil_test.dir/cmake_clean.cmake
.PHONY : muduo/base/tests/CMakeFiles/fileutil_test.dir/clean

muduo/base/tests/CMakeFiles/fileutil_test.dir/depend:
	cd /tmp/muduo/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/muduo /tmp/muduo/muduo/base/tests /tmp/muduo/build /tmp/muduo/build/muduo/base/tests /tmp/muduo/build/muduo/base/tests/CMakeFiles/fileutil_test.dir/DependInfo.cmake --color=$(COLOR)
